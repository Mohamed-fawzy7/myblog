...
import { faHeart as fasHeart, faShareAlt, faCamera, faEnvelopeOpenText } from '@fortawesome/free-solid-svg-icons';
...
export class AppModule {
    constructor(private library: FaIconLibrary) {
        library.addIcons(fasHeart, farHeart, faShareAlt, faFacebookF, faTwitter, faLinkedin, faCamera, faEnvelopeOpenText);
    }
}
